...
urlpatterns = [
    ...
    path('debitenote/<int:pk>',views.debitenote,name='debitenote'),
    ...
    path('debitsave',views.debitsave,name='debitsave'),
    path('add_partydetails',views.add_partydetails,name='add_partydetails'),
    path('add_partydetails_debit',views.add_partydetails_debit,name='add_partydetails_debit'),
]
